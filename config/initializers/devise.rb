...
Devise.setup do |config|
  ...
  # config.secret_key = 'b407e6b73dfb9cf5470487633a8d0ad5e3c7c99c3aa13da55143d488cfa6daa9756ee470a865592efca71321f04cb5b2865ba340006005a7be2e1ac2fa327d30'
  ...
  # config.pepper = 'ef862e06d07e3e790cc87b12c145e7f2fc05eb69150cfd620fc320c85ba95ecd8bc932d8fffdc67c9cc4231f2296a756f21b2db918d647303820698280413ccd'
  ...
  config.jwt do |jwt|
    ...
    jwt.expiration_time = 9999.days.from_now.to_i
      end
end
